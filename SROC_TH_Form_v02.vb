...
Public Class SROC_Form
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles ButtonOpenRoof.Click
        Select Case MsgBox("Are you sure that it is SAFE TO OPEN ROOF ?", MsgBoxStyle.YesNo, "*** SAFETY WARNING, ROOF MOVEMENT WILL BE ACTIVATED ***")
            Case MsgBoxResult.Yes
                MessageBox.Show("ROOF WILL NOW BE OPENED")
                SerialPort1.Write("ROOF_OPEN#" & vbCr) 'concatenate with \n
            Case MsgBoxResult.No
                MessageBox.Show("No roof movement will happen")
        End Select
    ...
    Private Sub ButtonCloseRoof_Click(sender As Object, e As EventArgs) Handles ButtonCloseRoof.Click
        Select Case MsgBox("Are you sure that it is SAFE TO CLOSE ROOF ?", MsgBoxStyle.YesNo, "*** SAFETY WARNING, ROOF MOVEMENT WILL BE ACTIVATED ***")
            Case MsgBoxResult.Yes
                MessageBox.Show("ROOF WILL NOW BE CLOSED")
